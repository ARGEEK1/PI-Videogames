      ...
      <header className={styles.header}>
        <nav className={styles.nav}>
          ...
          <ul className={open ? `${styles.navMenu} ${styles.navMenuVisible}` : styles.navMenu}>
            <li className={styles.navMenuIten}><Link to="/#" className={`${styles.navMenuLink} ${styles.navLink}`}>Create</Link>
            </li>
            <li className={styles.navMenuIten}><Link to="/home" className={`${styles.navMenuLink} ${styles.navLink}`}>Home</Link>
            </li>
            <li className={styles.navMenuIten}><Link to="/" className={`${styles.navMenuLink} ${styles.navLink} ${styles.navMenuLinkActive}`}>Logout</Link>
            </li>
          </ul>
        </nav>
      </header>
